            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Store Customers List</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card card-warning">
                    <div class="card-header sidebar-dark-primary elevation-4">
                        <h3 class="card-title">Store Customers List</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                        ...
                                        <tbody>
                                        @foreach($custo_mer as $custo)
                                            <tr role="row" class="odd">
                                                <td>{{ $custo->created_at }}</td>
                                                <td>{{ $custo->name }}</td>
                                                <td>{{ $custo->phone_number }}</td>
                                                <td>{{ $custo->transaction_id }}</td>
                                                <td>Rs. {{ $custo->price }}/-</td>
                                                <td>
                                                    <a class="btn btn-primary" href="#">
                                                        {{--<a class="btn btn-primary" href="{{ url('viewfull-particular-state-store-transaction-details', $custo->store_id) }}">--}}
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                </td>
                                            </tr>
