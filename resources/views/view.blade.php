                                ...
                                <div class="col-sm-12 table-responsive">
                                    <table id="table" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                        ...
                                        <tr role="row" class="odd" >
                                            ...
                                            <td>95698779</td>
                                            <td>
                                                <button type="submit" class="btn btn-sm btn-primary"><a href="{{route('assign.assign')}}" class="text-white">Assign</a></button>
                                                <button type="submit" class="btn btn-sm btn-primary"><a href="" class="text-white">Pick</a></button>
                                            </td>
                                        </tr>
                                        <tr role="row" class="even">
                                            ...
                                            <td>95698779</td>
                                            <td>
                                                <button type="submit" class="btn btn-sm btn-primary"><a href="" class="text-white">Assign</a></button>
                                                <button type="submit" class="btn btn-sm btn-primary"><a href="" class="text-white">Pick</a></button>
                                            </td>
                                        </tr>
                                        <tr role="row" class="odd">
